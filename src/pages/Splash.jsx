...
const Splash = () => {
  return (
    <div className="h-screen items-center justify-between flex flex-col" style={{ backgroundImage: `url(${bgImage})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }}>
        ...
        <div className='mt-64 flex items-center gap-4'>
            <Link to="/sign-up">
              <button className='bg-[#3152FA] text-white rounded-3xl px-7 py-2'>Sign up</button>
            </Link>
            <p>OR</p>
            <Link to="/sign-in">
              <button className='border border-[#FF7A00] text-[#FF7A00] rounded-3xl px-7 py-2'>Sign in</button>
            </Link>
        </div>
